            ...
            <div class=" w-2/4">
                ...
                <div class="relative overflow-x-auto">
                    ...
                    <div class="flex justify-center mt-5"> 
                        <a href="/login" type="button" class="text-center text-white w-60 bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Buy Now</a>
                    </div>
                </div>
