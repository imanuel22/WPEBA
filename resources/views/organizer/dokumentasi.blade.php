...
@section('main')
    ...
    <div class="">
        <h1 class="mb-4 text-xl font-bold">Table Events</h1>
    ...
    <div id="updateProductModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-2xl max-h-full p-4">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                <!-- Modal header -->
                <div class="flex items-center justify-between pb-4 mb-4 border-b rounded-t sm:mb-5 dark:border-gray-600">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Edit Dokumentasi</h3>
                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                        data-modal-toggle="updateProductModal">
                        <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewbox="0 0 20 20"
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2"><label for="description"
                            ...
                            <textarea id="description" rows="5"
                                class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Write a description...">Ini adalah deskripsi gambarnya Ini adalah deskripsi gambarnyaIni adalah deskripsi gambarnyaIni adalah deskripsi gambarnyaIni adalah deskripsi gambarnyaIni adalah deskripsi gambarnyaIni adalah deskripsi gambarnya</textarea>
                        </div>
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="flex justify-between mb-4 rounded-t sm:mb-5">
                    <div class="text-lg text-gray-900 md:text-xl dark:text-white">
                        <h3 class="font-semibold ">image.jpg</h3>
                ...
                <dl>
                    ...
                    <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum officiis consequatur voluptas ea quibusdam dolore alias debitis dolor odit magnam nobis beatae error laborum qui, officia ullam ab soluta ipsam?</dd>
