...
@section('main')
    <div class="">
        <form action="" method="POST" class="" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="images">Upload images
                    (Max 5)</label>
                <input
            ...
            <div class="mb-5">
                ...
                <select id="status" name="status"
                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <option value="" {{ old('status', $event['status']) == '' ? 'selected' : '' }}>Select status
                    </option>
                    <option value="upcoming" {{ old('status', $event['status']) == 'upcoming' ? 'selected' : '' }}>Upcoming
                    </option>
                    <option value="in_progress" {{ old('status', $event['status']) == 'in_progress' ? 'selected' : '' }}>In
                        Progress</option>
            ...
            <div class="mb-5">
                <label for="start_datetime" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Start Date
                    and Time</label>
            ...
            <div class="mb-5">
                <label for="duration" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Duration (in
                    minutes)</label>
            ...
            <div class="mb-5">
                <label for="event_category_ids"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Categories</label>
                <div class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-12 md:grid-cols-6">
