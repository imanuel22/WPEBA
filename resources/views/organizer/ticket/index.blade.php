                                    ...
                                    <form class=""
                                        ...
                                        <div class="grid grid-cols-3 gap-4 mb-4">
                                            ...
                                            <div class="col-span-3 md:col-span-2">
                                                <label for="price"
                                                    class="block mb-2 text-sm font-medium text-gray-200 dark:text-white">price</label>
                                            ...
                                            <div class="col-span-3 md:col-span-1 ">
                                                <label for="quantity"
                                                    class="block mb-2 text-sm font-medium text-gray-200 dark:text-white">quantity</label>
                                            ...
                                            <div class="col-span-3 md:col-span-1">
                                                <label for="payment_method"
                                                    class="block mb-2 text-sm font-medium text-gray-200 dark:text-white">payment_method</label>
                                            ...
                                            <div class="col-span-3 md:col-span-1">
                                                <label for="payment_number"
                                                    class="block mb-2 text-sm font-medium text-gray-200 dark:text-white">payment_number</label>
                                            ...
                                            <div class="col-span-3 md:col-span-1">
                                                <label for="payment_name"
                                                    class="block mb-2 text-sm font-medium text-gray-200 dark:text-white">payment_name</label>
