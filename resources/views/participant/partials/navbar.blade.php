            ...
            <div class="flex justify-end">
                <form class="max-w-md mx-auto">   
                    ...
                    <div class="relative">
                        ...
                        <input type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-lime-500 border border-lime-500 rounded-full bg-gray-50 dark:bg-transparent dark:border-lime-500 dark:placeholder-gray-400 dark:text-lime-700" placeholder="Search" required />
                    </div>
                </form>
            </div>
            </div>
