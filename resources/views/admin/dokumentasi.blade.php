...
<table id="selection-table">
    ...
    <tbody>
        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer">
            ...
            <td>ini Deskripsi</td>
            <td>
                <button type="button" class="focus:outline-none text-white bg-red-500 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800" onclick="return confirm('Apakah anda ingin menghapus dokumentasi ini?')">
                    Hapus
                </button>
            </td>
        </tr>
